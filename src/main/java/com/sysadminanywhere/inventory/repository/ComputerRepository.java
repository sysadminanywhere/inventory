...
public interface ComputerRepository extends JpaRepository<Computer, Long> {
    ...
    @Query("SELECT new com.sysadminanywhere.inventory.controller.dto.ComputerDto(c.id, c.name, c.dns) FROM Computer c JOIN c.installations i WHERE i.software.id = :softwareId")
    Page<ComputerDto> getComputersWithSoftware(@Param("softwareId") Long softwareId, Pageable pageable);
