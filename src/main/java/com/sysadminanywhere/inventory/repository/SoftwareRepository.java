...
public interface SoftwareRepository  extends JpaRepository<Software, Long>  {
    ...
    @Query("select new com.sysadminanywhere.inventory.controller.dto.SoftwareCount(s.name, s.vendor, s.version, count(i)) from Software s JOIN s.installations i GROUP BY s.name, s.vendor, s.version order by s.name")
